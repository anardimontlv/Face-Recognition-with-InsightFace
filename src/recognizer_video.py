...
ap.add_argument("--video-out", default="../datasets/videos_output/",
...
def main () : 
    ...
    csv_output_file_name = args.video_out + "output_" + timestr + ".csv"
    args.video_out = args.video_out + "output_video_" + timestr + ".mp4"
    video_out = cv2.VideoWriter(args.video_out, cv2.VideoWriter_fourcc(*'mp4v'), 24, (save_width,save_height))
